...
$(document).ready(function () {
   ...
   if( !device.tablet() && !device.mobile() && !isIE9() ) {
	...
	var map;
	var myLatlng = new google.maps.LatLng(32.7765, -79.9311); // Specify YOUR coordinates
    ...
    },
    {
	  ...
	  var image = new google.maps.MarkerImage("assets/images/heart_icon2.png", null, null, null, new google.maps.Size(55,57));
	
	  // Includes custom marker on map
	  var myLatLng = new google.maps.LatLng(32.79, -79.9311);
